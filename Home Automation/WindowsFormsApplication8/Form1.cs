    ...
    public partial class Main : Form
    {
        ...
        private void saveValues()
        {
            ...
            catch (Exception Err)
            {
                ...
                var x = MessageBox.Show(message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                addEvent(message);
        ...
        private void loadValues()
        {
            ...
            addEvent("loading presets from " + file);
        ...
        private void addEvent(string text)
        {
            ...
            listBoxEvents.Items.Insert(0, stamp + " : " + text);
